    ...
    <div class="sidebar-wrapper sidebar-theme">
        <nav ref="menu" id="sidebar">
            ...
            <perfect-scrollbar class="list-unstyled menu-categories" tag="ul" :options="{ wheelSpeed: 0.5, swipeEasing: !0, minScrollbarLength: 40, maxScrollbarLength: 300, suppressScrollX: true }">
                ...
                <li class="menu">
                    <router-link to="/admin" class="dropdown-toggle" @click="toggleMobileMenu">
                        <div class="">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                ...
                <li class="menu" v-if="this.active_roles == 1 && this.active_permissions.includes('users-create')">
                    <router-link to="/admin/employees" class="dropdown-toggle" id="admin-user-id" @click="toggleMobileMenu">
                        <div class="">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                ...
                <li class="menu">
                    <router-link to="/admin/accounts" id="company-user-id" class="dropdown-toggle" @click="toggleMobileMenu">
                        <div class="">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                ...
                <li class="menu">
                    <a class="dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#pages" aria-controls="pages" aria-expanded="false">
                        <div class="">
                            ...
                            <span>{{ $t('Product Registrations') }}</span>
                        </div>
                        <div>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <ul id="pages" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        <li>
                            <router-link to="/admin/product-registrations/all" @click="toggleMobileMenu">All</router-link>
                        </li>
                        <li>
                            <router-link to="/admin/product-registrations/pending" @click="toggleMobileMenu">Pending</router-link>
                        </li>
                        <li>
                            <router-link to="/admin/product-registrations/approved" @click="toggleMobileMenu">Approved</router-link>
                        </li>
                        <li>
                            <router-link to="/admin/product-registrations/declined" @click="toggleMobileMenu">Declined</router-link>
                        </li>
...
<script>
    ...
    export default {
        ...
        data () {
            return {
                active_roles: JSON.parse(sessionStorage.getItem('ROLES')),
                permissionsObj: JSON.parse(sessionStorage.getItem('PERMISSIONS')),
                active_permissions: [],
                router: useRouter(),
                current_path: this.$router.currentRoute.fullPath,
            }
        },
        computed: {
            current_path(){
                this.current_path = this.$router.currentRoute;
                return this.current_path;
            }
        },
        watch: {
            current_path(){
                console.log("changes in sidebar");
                console.log(this.current_path.fullPath);
            }
        },
        methods: {
            getPermissions(){
                ...
                this.permissionsObj.forEach(element => {
                    // console.log(element.name);
                    this.active_permissions.push(element.name);
                });
            },
        },
        created: function(){
