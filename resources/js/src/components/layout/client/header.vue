            ...
            <header class="header navbar navbar-expand-sm">
                <ul class="navbar-item theme-brand flex-row text-center">
                    <li class="nav-item theme-logo">
                        <router-link to="/">
                            <img src="https://covueior.com/assets/img/covue_logo_white.png" class="navbar-logo" alt="logo" />
                        </router-link>
                    </li>
                    <li class="nav-item theme-text">
                        <router-link to="/client/index" class="nav-link"> Client </router-link>
                    </li>
                </ul>
                ...
                <div class="navbar-item flex-row ms-md-auto">
                    ...
                    <div class="dropdown nav-item user-profile-dropdown btn-group">
                        <a href="javascript:;" id="ddluser" data-bs-toggle="dropdown" aria-expanded="false" class="btn dropdown-toggle btn-icon-only user nav-link">
                            <img
                                :src="$store.state.user.data.avatar ? '/storage/user_avatar/'+$store.state.user.data.id+'/'+$store.state.user.data.avatar : 'https://ui-avatars.com/api/?name='+ $store.state.user.data.fname + '+' + $store.state.user.data.lname"
                                alt="profile"
                            />
                        </a>
